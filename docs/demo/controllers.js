(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["550d61647d25bb15ff73e26eb6c38c34"] = factory();
	else
		root["550d61647d25bb15ff73e26eb6c38c34"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_point_intercept_src_server_index__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_point_intercept_src_server_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_corespring_legacy_point_intercept_src_server_index__);
...
let createOutcome = (question, session) => {
  return __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_point_intercept_src_server_index___default.a.createOutcome(question, session.value.answers, {
    showFeedback: true,
...
function createOutcome(question, answer, settings) {
  ...
  if(_.isEmpty(answer)){
    return {
      correctness: 'warning',
      score: 0,
      feedback: settings.showFeedback ? serverUtils.makeFeedback(question.feedback, 'warning') : null,
  ...
  if (settings.showFeedback) {
    ...
    res.feedback = serverUtils.makeFeedback(question.feedback, serverUtils.correctness(isCorrect, isPartiallyCorrect));
  }
...
/***/ function(module, exports, __webpack_require__) {
         ...
         exports['corespring-point-intercept-ng15'] = __webpack_require__(2);
         exports['corespring-point-intercept-ng15'].version = '../node_modules/corespring-point-intercept-ng15/controller';
